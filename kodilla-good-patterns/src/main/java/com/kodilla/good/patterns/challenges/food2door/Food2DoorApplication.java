...
public class Food2DoorApplication {
    ...
    public static void main(String[] args) {
        ...
        OrderRequest orderRequest1 = new OrderRequest(productRepository.getProductFromRepository("Curly Kale", 3.25, true), 3);
        OrderRequest orderRequest2 = new OrderRequest(productRepository.getProductFromRepository("Corn Bread", 8.0, true), 8);
        OrderRequest orderRequest3 = new OrderRequest(productRepository.getProductFromRepository("Organic Tomato", 4.18, true), 12);
