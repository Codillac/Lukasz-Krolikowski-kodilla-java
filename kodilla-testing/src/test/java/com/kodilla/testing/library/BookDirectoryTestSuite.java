...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testListBooksWithConditionMoreTan20(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
    ...
    // ------ Task 6.6 -------
    @Test
    public void testListBooksInHandsOfZeroBookUser(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("John", "Smith", "7504158871");
        List<Book> resultListOfBooks = new ArrayList<Book>();
    ...
    @Test
    public void testListBooksInHandsOfOneBookUser(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("John", "Smith", "7504158871");
    ...
    @Test
    public void testListBooksInHandsOfFiveBooksUser(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("John", "Smith", "7504158871");
